...
public class CourseViewUi extends RecyclerView.ViewHolder {
    ...
    public CourseViewUi(@NonNull View itemView) {
        super(itemView);
       ...
       // System.out.println(itemView.findViewById(R.id.viewUsers_main_page)+"edit course is null");
        System.out.println((description==null)+"description course is null");
        System.out.println((enroll==null)+"enroll course is null");
        System.out.println((remove==null)+"remove course is null");
